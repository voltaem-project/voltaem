...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid voltaem address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        #fund a tx with ~20 small inputs, by spending in combination the 22 VAEM we just sent
        inputs = []
