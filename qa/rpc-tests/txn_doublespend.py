...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 7,500,000 VAEM:
        ...
        # First: use raw transaction API to send 7440000 VAEM to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 500,000 VAEM for another
        ...
        # Node0's total balance should be starting balance, plus 1000000 VAEM for 
