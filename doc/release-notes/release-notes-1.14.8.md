Voltaem Core version 1.14.8 is now available from:

  <https://github.com/voltaem/voltaem/releases/tag/v1.14.8/>

This is a new minor version release. Voltaem users on any platform are
...
Several important updates have been added to Voltaem Core, including fixes
backported from Bitcoin Core's upstream.

### Reduce Peer INV Object Counts

Previously, Voltaem Core nodes would maintain a large list of inventory for
...
A new transaction request tracking system improves the way Voltaem Core
...
In previous versions of Voltaem Core, orphan transactions were processed in a
...
Voltaem Core now sends a getheaders message for one block when announced in an
...
vulnerability or security issue in Voltaem Core.
...
* Voltaem Core now supports compilation with C++14 and C++17, if you select
