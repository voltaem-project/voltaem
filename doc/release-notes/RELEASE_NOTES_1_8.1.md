...
Voltaem Core 1.8.1 is primarily a bugfix release, bringing Voltaem Core in
line with Bitcoin 0.9.3. Voltaem Core 1.8.1 also adds in support for printing
...
## Voltaem Core Release Notes

* Translation improvements and corrections
* Disable Transifex based translation process (not used by Voltaem Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 Voltaem Core clients
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/voltaem/voltaem/issues/134).
