...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s voltaem-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  voltaem-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded voltaem transaction") + "\n" +
              "  voltaem-tx [options] -create [commands]   " + _("Create hex-encoded voltaem transaction") + "\n" +
              "\n";
