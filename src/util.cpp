...
const char * const BITCOIN_CONF_FILENAME = "voltaem.conf";
const char * const BITCOIN_PID_FILENAME = "voltaemd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Voltaem";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Voltaem";
#else
    // Unix
    return pathRet / ".voltaem";
#endif
#endif
}
