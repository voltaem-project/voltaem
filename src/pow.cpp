...
bool AllowMinDifficultyForBlock(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    // Voltaem: Magic number at which reset protocol switches
...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    // Voltaem: Special rules for minimum difficulty blocks with Digishield
    ...
    bool fNewDifficultyProtocol = (pindexLast->nHeight >= 100);
    ...
    return CalculateVoltaemNextWorkRequired(pindexLast, pindexFirst->GetBlockTime(), params);
}
