...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Voltaem Core repository on GitHub"),
        tr("Services that claim to double your voltaems are always ponzi schemes")
    };
