...
// Copyright (c) 2020-2023 The Voltaem Core developers
...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Voltaem: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Voltaem (as there is no actual maximum coins)
