...
/** Recommended transaction fee by Voltaem Core developers
  *
 ...
 *
 *  Voltaem:    Increment mempool limits and accept RBF in steps of 0.0001 VAEM
...
/**
 * Voltaem: Default dust limit that is evaluated when considering whether a
...
/**
 * Voltaem: Default hard dust limit that is evaluated when considering whether
